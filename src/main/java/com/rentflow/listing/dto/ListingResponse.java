...
public record ListingResponse(
    ...
    public ListingResponse(UUID id, UUID vehicleId, UUID hostId, String title,
                          ...
                          String suspensionReason, String suspensionSource, Instant suspensionUntil,
        ...
        this(id, vehicleId, hostId, title, description, city, address,
             ...
             instantBook, cancellationPolicy, status, suspensionReason, suspensionSource, suspensionUntil,
             null, createdAt, null,
